...
namespace InvoiceManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20230202185913_UserRefreshTokenDate")]
    partial class UserRefreshTokenDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceManagementSystem.Entity.Entities.Concrete.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("InvoiceManagementSystem.Entity.Entities.Concrete.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("InvoiceManagementSystem.Entity.Entities.Concrete.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InvoiceManagementSystem.Entity.Entities.Concrete.Identity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
